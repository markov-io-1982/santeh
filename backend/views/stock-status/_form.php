            ...
            <?= $form->field($model, 'name_' . Yii::$app->language, [
                'template' => '
                    ...
                    <div class="input-group">
                        {input}'.
                        '<span class="input-group-addon btn-other-name-stock-status" title="Other name"><i class="fa fa-language"></i></span>
                    </div>
                    {error}
                ',
            ]); ?>
    
            <div class="row other-name-stock-status" style="display:none;">
                <div class="col-md-12">
