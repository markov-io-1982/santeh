    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'attribute_id')->dropDownList(
                ...
                ['prompt'=> '-- ' . Yii::t('app', 'Select attribute value') . ' --']
            ) ?> 
            ...
            <?= $form->field($model, 'name_' . Yii::$app->language, [
                'template' => '
                    ...
                    <div class="input-group">
                        {input}'.
                        '<span class="btn-other-name-attribute-value input-group-addon" title="Other name"><i class="fa fa-language"></i></span>
                    </div>
                    {error}
                ',
            ]); ?>
    
            <div class="row other-name-attribute-value" style="display:none;">
                <div class="col-md-12">
