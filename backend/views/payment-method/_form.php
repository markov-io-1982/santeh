        ...
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'name_' . Yii::$app->language, [
                'template' => '
                    ...
                    <div class="input-group">
                        {input}'.
                        '<span class="btn-other-name-payment-method input-group-addon" title="Other name"><i class="fa fa-language"></i></span>
                    </div>
                    {error}
                ',
            ]); ?>
    
            <div class="row other-name-payment-method" style="display:none;">
                <div class="col-md-12">
            ...
            <?= $form->field($model, 'description_' . Yii::$app->language, [
                'template' => '
                    ...
                    <div class="input-group">
                        {input}'.
                        '<span class="btn-other-description-payment-method input-group-addon" title="Other description"><i class="fa fa-language"></i></span>
                    </div>
                    {error}
                ',
            ]); ?>
    
            <div class="row other-description-payment-method" style="display:none;">
                <div class="col-md-12">
                    <?php foreach (Yii::$app->params['languages'] as $key => $language): ?>
