...
/* @var $searchModel backend\models\PromoStatusSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Promo Statuses');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="promo-status-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('app', 'Create Promo Status'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
