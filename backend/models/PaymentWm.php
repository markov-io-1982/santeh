...
class PaymentWm extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'amt', 'details', 'order_id', 'payee_purse', 'payment_no', 'payment_amount', 'sys_invs_no', 'sys_trans_no', 'sys_trans_date', 'payer_purse', 'payer_wm', 'date_create', 'phone', 'status', 'note'], 'required'],
            [['order_id', 'mode', 'status'], 'integer'],
