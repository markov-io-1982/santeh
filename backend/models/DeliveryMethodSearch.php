...
/**
 * DeliveryMethodSearch represents the model behind the search form about `backend\models\DeliveryMethod`.
 */
class DeliveryMethodSearch extends DeliveryMethod
{
    ...
    public function rules()
    {
        return [
            ...
            [['name_en', 'name_ru', 'name_ua', 'description_en', 'description_ru', 'description_ua'], 'safe'],
        ];
    }
